...
export default function PaymentWidget({ profile }) {
  ...
  const handleUnlock = async () => {
    ...
    try {
      ...
      console.log("Payment payload from API:", paymentPayload);

      // ✅ Use direct FlutterwaveCheckout (no hook)
      const config = {
      ...
      console.log("Opening Flutterwave with config:", config);

      // ✅ Launch Flutterwave directly
